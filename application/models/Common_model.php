...
public function update_table($table_name='', $array='', $where='', $test=0)
    ...
    $insert_data=array(
       ...
       // $this->createAndSaveAdmissionLink($insert_id);
         ...
         $result=$this->db->insert('users',$insert_db);
         $insert_id2=$this->db->insert_id();
         $batch_id=$payment_info['batch_id'];
         $exam=$this->db->query("select id from exams where bhatia_batch_id=".$batch_id." ")->row_array();
        ...
        $this->db->insert('users_exams',$insert_users_exams);
