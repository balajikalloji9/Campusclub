        ...
        <div class="main-content-inner">
          <div class="breadcrumbs" id="breadcrumbs">
            ...
            <ul class="breadcrumb">
              ...
              <li>                 
                <a href="<?php echo site_url();?>admin/sports">Sports</a>
              </li>
          ...
          <div class="page-content">
            <div class="page-header-2">
              <h1 class="col-lg-4 col-md-3 col-sm-3 col-xs-12 pdg-top-10">
                <i class="menu-icon fa fa-list-ul blue"></i>Sports
            ...
            <div class="row">
              <div class="col-xs-12">
                <!-- PAGE CONTENT BEGINS -->
                    <form class="form-horizontal" role="form" name="myform" id="myform" method="post" action="<?php echo base_url()?>admin/sports/update_records" enctype="multipart/form-data">
              <div class="row">
                <div class="col-lg-9 col-xs-12 col-sm-9 col-md-9 col-lg-offset-1">
                  ...
                  <input class="form-control" name="name" id="" type="text" value="<?php echo $record['name']?>" required="">
                    </div>
                  </div>

                  <input class="form-control" name="id"  type="hidden" value="<?php echo $record['id']?>" required="">
                ...
                <div class="col-lg-12 col-xs-12 col-sm-12">
                  ...
                  <a class="btn btn-danger btn-sm" type="edit" href="<?php echo base_url();?>admin/sports">Back </a>
