            ...
            <div class="row">
              ...
              <div class="row">
                <div class="col-lg-9 col-xs-12 col-sm-9 col-md-9 col-lg-offset-1">
                  ...
                  <input class="form-control" name="slot_name" id="" type="text" value="" required="">
                    </div>
                  </div>
                  ...
                  <div class="row form-group frm-btm">
                    ...
                    <input class="form-control date-picker" name="from_date" id="id-date-picker-1" value="" data-date-format="yyyy-mm-dd" required="">
                    </div>
                  </div>
                 ...
                 <div class="row form-group frm-btm">
                    ...
                    <div class="col-lg-7 col-md-7 col-sm-7 col-xs-6 word-brk">
                    <!-- <input class="form-control" name="date" id="" value="<?php echo date('d-m-Y')?>" readonly> -->
                    <input class="form-control date-picker" name="to_date" id="id-date-picker-1" value="" data-date-format="yyyy-mm-dd" required="">
                    </div>
                  </div>
                  ...
                  <div class="row form-group frm-btm">
                    ...
                    <div class="col-lg-1 col-xs-1 col-sm-1 col-md-1 input-text"> : </div>
                    <div class="col-lg-7 col-md-7 col-sm-7 col-xs-6 word-brk">
                      <input class="form-control" name="from_time" id="timepicker1" value="" required>
                    </div>
                  </div> 
                  ...
                  <div class="row form-group frm-btm">
                    ...
                    <div class="col-lg-1 col-xs-1 col-sm-1 col-md-1 input-text"> : </div>
                    <div class="col-lg-7 col-md-7 col-sm-7 col-xs-6 word-brk">
                      <input class="form-control" name="to_time" value="" id="timepicker2"  required>
                    </div>
                  </div>
                  ...
                  <div class="row form-group frm-btm">
                    ...
                    <div class="col-lg-1 col-xs-1 col-sm-1 col-md-1 input-text"> : </div>
                    <div class="col-lg-7 col-md-7 col-sm-7 col-xs-6 word-brk">
                      <input class="form-control" name="no_of_players" value="" required>
                    </div>
                  </div>
                  ...
                  <div class="row form-group frm-btm">
                    ...
                    <div class="col-lg-7 col-md-7 col-sm-7 col-xs-6 word-brk">
                      <select class="form-control" name="select_day_type" id="select_day_type" required="" onchange="selectdays(this.value)">
                                <option value="1">Select the days</option>
                                <option value="2">All Days</option>
                      </select>
                    </div>
                  </div>

                  <div class="row form-group frm-btm" id="all_days_div" style="display:none">
                    <div class="col-lg-3 col-sm-3 col-md-3 col-xs-5">
                  ...
                  <div class="row form-group frm-btm" id="select_days_div">
                    <div class="col-lg-3 col-sm-3 col-md-3 col-xs-5">
                    ...
                    <div class="col-lg-7 col-md-7 col-sm-7 col-xs-6 word-brk">
                      ...
                      <?php
                                if(!empty($days))
                                {
                                  ...
                                  {
                                    ?>
                                    <input class="form-control" type="checkbox" name="days[]" value="<?php echo $day['id'] ?>" id="" ><?php echo $day['day'] ?>
                                    <?php
                                  }
                                }
                                ?>
                  ...
                  <div class="row form-group frm-btm">
                    ...
                    <textarea class="form-control" type="text" rows="6" placeholder="Should not exceed 250 Characters..." name="description" id="description" value="" data-parsley-id="8322"></textarea><ul class="parsley-errors-list" id="parsley-id-8322"></ul>
                    </div>
                  </div> 
