      ...
      <h1 class="col-lg-3 col-sm-4 col-md-5 col-xs-7 mbl-mgbtm-5 pdg-top-10">
       ...
       Slots
        ...
        <div class="pull-right "> 
          <a href="<?php echo base_url();?>admin/slots/add" class="btn btn-success btn-sm" type="button"><i class="fa fa-plus fa-lg"></i> Add Slots</a> 
        ...
        <div class="panel-body">
          ...
          <div id="wait" style="display:none;width:69px;height:89px;position:absolute;top:50%;left:50%;padding:2px; z-index:99999999"><img src='<?=base_url();?>assets/img/demo_wait.gif' width="64" height="64" /></div>
            ...
            <form id="fees_form" name="search_fees" method="post" class="pull-right">
              ...
              <a class="btn btn-danger" style="display:none;" id="searchreset" href="<?php echo base_url('admin/slots'); ?>"><li class="fa fa-minus icon-style"></li></a>
              </div>
            </form> 
            <!-------- /Search Form ---------->
            </table>                                            
...
<script>
    ...
    $(document).ready(function () {
        ...
        "destroy": true,
        "ajax": {
            "url": "<?php echo base_url('admin/slots/all_records'); ?>",
            "type":"POST",
            beforeSend: function() {
        ...
        "columns": [
            ...
            { "title": "Slot Name", "name":"slot_name","orderable": false, "data":"slot_name", "width":"0%" },

            { "title": "Sports", "name":"state","orderable": false, "data":"sport_name", "width":"0%" },
      
            { "title": "Days", "name":"days","orderable": false, "data":"days", "width":"0%" },

            { "title": "From Data", "name":"from_date","orderable": false, "data":"from_date", "width":"0%" },

            { "title": "To Date", "name":"to_date","orderable": false, "data":"to_date", "width":"0%" },

            { "title": "From time", "name":"from_time","orderable": false, "data":"from_time", "width":"0%" },

            { "title": "To time", "name":"to_time","orderable": false, "data":"to_time", "width":"0%" },
             { "title": "No of players", "name":"no_of_players","orderable": false, "data":"no_of_players", "width":"0%" },
        ...
        {           
          ...
          //var view_attch ='<a target="_blank" class="btn btn-primary btn-condensed" title="view" href="'+url+'admin/slots/view_slot/'+aData['id']+'">View</a>';
         ...
         // $(nRow).find('td:eq(2)').html(image)
          ...
          var action ='<a class="btn btn-warning btn-condensed" title="edit" href="'+url+'admin/slots/edit/'+aData['id']+'">Edit</a>';

          $(nRow).find('td:eq(10)').html(action);         


        
        var delete_s ='<a onclick="return confirm('+"'Are you sure want to delete?'"+');" class="btn btn-danger btn-condensed" title="delete" href="'+url+'admin/slots/delete/'+aData['id']+'"><i class="fa fa-trash"></i></a>';
            $(nRow).find('td:eq(11)').html(delete_s);
